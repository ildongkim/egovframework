...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/js/tpssm/com/scripts.js'/>"></script>
</head>
<body>
    <!-- Responsive navbar-->
    ...
    <div class="container">
        ...
        <div class="Static sta_LOGIN_Caption" tabindex="-1" style="left:-1px;top:25px;width:614px;height:100px;direction:ltr;text-align: center;"
        role="" aria-label="임시출입자 출입신청심의 시스템은 사용자의 개인정보보호정책을 준수합니다.">
			임시출입자 출입신청심의 시스템
			<p><span style="font-size:12pt;color:#939393">임시출입자 출입신청심의 시스템은 사용자의 개인정보보호정책을 준수합니다.</span></p>
        </div>
        <div class="Static sta_LOGIN_Image" style="left:75px;top:173px;width:614px;height:387px;direction:ltr;" role="" aria-label=" " aria-description=""></div>
    </div>
</body>
</html>